...
--
-- Host: localhost
-- Generation Time: Jan 08, 2024 at 10:30 AM
...
INSERT INTO `stu` (`stud_name`, `stud_id`, `dept_name`, `level`, `term`, `course_title`, `course_no`, `grade`, `point`) VALUES
('audrey', 1, 'eee', 2, 2, 'comp6461', 6461, 'A', 4);
...
INSERT INTO `teacher` (`userid`, `password`, `dept`) VALUES
(1, '123', 'eee');
